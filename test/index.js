...
;(async () => {
    ...
    reportMemory();
    console.log(`\tincludesAll([1, 2, 3], [1, 2, 3]) includesAll([1, 2, 3], [4])\n\t\t${includesAll([1, 2, 3], [1, 2, 3])} ${includesAll([1, 2, 3], [4])} / true false [criteria]`);
    ...
    console.log(`\nQUICK TEXT COMPARE: ====================`);
    console.log(`\tquickTextCompare("first text of 5 words", "first text of 5 words")\n\t\t${quickTextCompare("first text of 5 words", "first text of 5 words")} / true [criteria]`);
    console.log(`\tquickTextCompare("first text of 5 words", "second text of 5 words")\n\t\t${quickTextCompare("first text of 5 words", "second text of 5 words")} / true [criteria]`);
    console.log(`\tquickTextCompare("first text of 5 words", "my second text of 6 words")\n\t\t${quickTextCompare("first text of 5 words", "my second text of 6 words")} / false [criteria]`);
})();